...
const regions = [
    ...
    {
        value: "Asia excl. Greater China",
        name: "Asia excl. Greater China",
    },
...
const localConfig = {
    ...
    githubApp:
        process.env.REACT_APP_GITHUB_APP || "Iv1.10e7aaed4654db3c",
    oauthUri:
        process.env.REACT_APP_OAUTH_URI ||
    ...
    approvalsThreshold:
        process.env.REACT_APP_APPROVALS_THRESHOLD || "1",
    largeClientRequest: 5497558000000000000000000,
    metrics_api_environment:
        process.env.REACT_APP_METRICS_API_ENVIRONMENT || "test",
...
const prodConfig = {
    ...
    filecoinContentOwner: "keyko-io",
    githubApp:
        process.env.REACT_APP_GITHUB_APP || "Iv1.1490209508f9ed93",
    oauthUri:
        process.env.REACT_APP_OAUTH_URI ||
        "http://localhost:3000/oauth/",
    networks: "Mainnet",
    ...
    metrics_api_environment:
        process.env.REACT_APP_METRICS_API_ENVIRONMENT || "test",
    loggerApiKey: process.env.REACT_APP_X_API_KEY || "",
    secretRecieverAddress:
        process.env.REACT_APP_SECRET_RECIEVER_ADDRESS,
    lotusNodes: [
        {
            name: "Mainnet",
            code: 461,
...
export const config = process.env.REACT_APP_NETWORKS !== 'Mainnet' ?
