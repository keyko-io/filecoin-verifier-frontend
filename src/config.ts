export const config = {
    ...
    secretRecieverAddress: process.env.REACT_APP_SECRET_RECIEVER_ADDRESS || 'f1zenfgvgwjmfppzjrfibvii3hkx5agzvmcctmi3y',
    // secretRecieverAddress: process.env.REACT_APP_SECRET_RECIEVER_ADDRESS || 't01000',
