export const config = {
    ...
    minersOwner: process.env.REACT_APP_MINERS_REPO ||'keyko-io',
    minersRepo:process.env.REACT_APP_MINERS_REPO || 'filecoin-clients-onboarding-test',
    minersIssueNumber: process.env.REACT_APP_MINERS_ISSUE ||105,
