...
const ApproveLargeRequestModal = (props: ModalProps) => {
    ...
    const { selectedClientRequests, open, onClick: verifyLargeRequest, handleClose } = props
    ...
    const onClickHandler = async () => {
        ...
        handleClose()
        if (!isSignable) {
            alert('you are not allowed to sign one or more of the selected transactions')
            return
        }
        ...
        <Modal open={open} onClose={handleClose}>
            ...
            >
                ...
                <table>
                    ...
                    <tbody>
                        {selectedClientRequests.map((request: LargeRequestData, index: any) => (
                            <tr key={index}>
