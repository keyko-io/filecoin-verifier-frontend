  ...
  return (
    <div className="deprecation-warning" role="alert">
      ...
      <p>
        ...
        list of active allocators</a> or the <a href="https://github.com/filecoin-project/Allocator-registry" target="_blank" rel="noreferrer">active list of allocators</a> who have verified public datasets. 
