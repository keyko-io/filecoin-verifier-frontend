                ...
                <React.Fragment>
                    ...
                    <div className='info'>
                        ...
                        <div className='description'>
                            Here is where you can action pending Notary allocation decisions.To
                            become a rootkey holder, you’ll need to have been selected by the
                            network originally.
                        </div>
                    </div>
                    <div className='buttons'>
                        ...
                        <div
                            className={config.dev_mode === 'dev' ? 'button right' : 'button center'}
                        >
                            <ButtonPrimary
                                onClick={loadLedgerWallet}
                                style={{ minWidth: '220px', boxShadow: 'none' }}
                            >
                ...
                <React.Fragment>
                    ...
                    <div className='info'>
                        ...
                        <div className='description'>
                            ...
                            allocation decisions. To become a rootkey holder, you’ll need to have
                            been preselected.
                        </div>
                    </div>
                    <div className='tabs'>
