    ...
    return (
        <div className="loginmodal">
            <>
                ...
                <div className="tabs">
                    <div className={multisig ? "tab selected" : "tab"} onClick={() => setMultisig(true)}>Organization</div>
                </div>
                <div className="buttons">
                    {!config.networks.includes('Mainnet') ?
                        <div className="button left">
                            ...
                            {true ?
                                <input className="multisiginput" name="address" placeholder="Multisig address" value={address} onChange={(e) => setAddress(e.target.value)} />
                                : null
                            }
                        </div>
                        : null}
