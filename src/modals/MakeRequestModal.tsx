...
class MakeRequestModal extends Component<ModalProps, States> {
    ...
    handleGithubSubmit = async () => {
        ...
        if (datacap > config.largeClientRequest) {
            response = await this.context.createRequest({
                ...
                contact: this.state.contact,
                assigness:
                    config.lotusNodes[this.context.wallet.networkIndex].largeClientRequestAssign,
                onboarding: true,
    ...
    render() {
        return (
            <div
                className='addmodal requestmodal'
                style={this.props.verifier.docs_url ? {} : { height: 680 }}
            >
                <form>
                    ...
                    {this.state.redirect && (
                        ...
                        >
                            <div style={{ lineHeight: '1.3' }}>
                                Direct notary allocations are in the 0-1024 TiB range. To request
                                more DataCap, please apply for a large dataset instead. Click here
                                to apply.
                            </div>
                            <button
                    ...
                    <div className='makerequest'>
                        ...
                        <div className='inputholder'>
                            <div className='regionlabel'>
                                Region (Where you, the Client, are based)
                            </div>
                            <div className='datacapext'>
                                <SelectMenu
                                    name='region'
                        ...
                        {this.props.verifier.docs_url ? (
                            <div className='docsmessage'>
                                Before submitting your request, please make sure to check out the
                                guidelines and criteria to accept Datacap request for{' '}
                                <a
                                    href={this.props.verifier.docs_url}
                                    target='_blank'
                                    rel='noopener noreferrer'
                                >
                                    {this.props.verifier.name}
                                </a>
                            </div>
                        ) : null}
                    </div>
                    <div
                        className='centerbutton buttondiv'
                        style={this.props.verifier.docs_url ? {} : { paddingTop: 0, marginTop: 0 }}
                    >
                        <div id='sendbutton'>
