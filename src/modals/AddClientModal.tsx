        ...
        return (
            <div className="addmodal">
                <form>
                    ...
                    <div className="ledgermessage">You are about to send a message to assign DataCap to this address.Please check your Ledger to sign and send the message.</div>
