...
export const coreInfo = [
  ...
  export const guidelines = [
    ...
    { view: 3, title: 'Fill the form.', description: 'Step 1 of 4. This is mandatory. If you don\'t have time right now, you can submit the issue and finish it later.', className: 'welcome3' },
    { view: 3, title: 'Fill the form.', description: '', className: 'welcome4' },
