...
const resourcesLinks = [
    ...
    {
        link: 'https://github.com/filecoin-project/filecoin-plus-client-onboarding',
        desc: 'Client Onboarding',
    },
    {
        link: 'https://github.com/filecoin-project/filecoin-plus-large-datasets',
        desc: 'Fil+ for Large Datasets',
    },
]
        ...
        <div className='footer'>
            ...
            <div className='reach_out'>
                ...
                <div className='reach_out-links'>
                    <a
                        href='https://filecoinproject.slack.com/?redir=%2Farchives%2FC01DLAPKDGX'
                        target='_blank'
